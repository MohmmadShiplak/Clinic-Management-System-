...
namespace Clinic_Management_system
{
    public partial class frmListMedicalRecords : Form
    {
        ...
        private void updateMedicalToolStripMenuItem_Click(object sender, EventArgs e)
        {
            int MedicalID = (int)dgvMedicalRecords.CurrentRow.Cells[0].Value;


            frmAddUpdateMedicalRecords frm1 = new frmAddUpdateMedicalRecords(MedicalID);
            frmListMedicalRecords_Load(null, null);
            frm1.ShowDialog();

        }

        private void deleteMedicalToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            frmAddUpdateMedicalRecords frm1 = new frmAddUpdateMedicalRecords();
            frm1.ShowDialog();
            frmListMedicalRecords_Load(null, null);
