...
namespace Clinic_Management_system
{
    public partial class frmAddUpdateAppointment : Form
    {
        ...
        private void FillAppointmentsInfo()
        {
            ...
            ctrlDoctorCardWithFilter2.LoadDoctorsInfoByDoctorID(_Appointment.DoctorID);
            ctrlPatientCardWithFilter1.LoadPatinetsInfo(_Appointment.PatientID);
        ...
        private void btSave_Click(object sender, EventArgs e)
        {
           ...
           _Appointment.DoctorID = ctrlDoctorCardWithFilter2.DoctorID;
